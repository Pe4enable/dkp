 ...
 */
public class IBuildContract implements Contract {
    public static final String IBUILD_CONTRACT_ID = "com.example.IBuildContract";
    ...
    public void verify(LedgerTransaction tx) {
        ...
        requireThat(require -> {
            ...
            final IBuildState out = tx.outputsOfType(IBuildState.class).get(0);
            ...
            require.using("The build's price must be non-negative.",
                    out.getPrice() > 0);
