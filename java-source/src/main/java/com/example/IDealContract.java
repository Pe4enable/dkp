 ...
 */
public class IDealContract implements Contract {
    public static final String IDEAL_CONTRACT_ID = "com.example.IDealContract";
    ...
    public void verify(LedgerTransaction tx) {
        ...
        requireThat(require -> {
            ...
            final IDealState out = tx.outputsOfType(IDealState.class).get(0);
